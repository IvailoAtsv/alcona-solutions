    ...
    >
      ...
      <div className="max-w-[1400px] w-full gap-4 items-start py-4 justify-between sm:flex-row flex-col flex">
        ...
        <Card
          ...
          text="Изключителна устойчивости"
          more="крайният продукт, изработен от WPC материали, е свободен от деформации и пукнатини. Този устойчив материал е водоустойчив, не загнива и не позволява образуването на плесени.
