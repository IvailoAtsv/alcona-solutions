        ...
        <FormWrapper title={title}>
            ...
            <div className="w-full flex justify-evenly items-center">
                <div className="flex flex-col justify-center items-center">
                    <p className=" text-lg font-semibold text-center pb-2">Соларна</p>
                    <img src={solar} className='w-40 h-40 rounded-md' />
                    <label className="text-lg">Брой:  </label>
                ...
                <div className="flex flex-col justify-center items-center">
                    <p className=" text-lg font-semibold text-center pb-2">LED 12v</p>
                    <img name="Caps" src={led} className='w-40 h-40 rounded-md' />
                    <label className="text-lg">Брой: </label>
                ...
                <div className="flex flex-col justify-center items-center">
                    <p className=" text-lg font-semibold text-center pb-2">Пластмасa</p>
                    <img src={plastic} className='w-40 h-40 rounded-md' />
                    <label className="text-lg">Брой:  </label>
            ...
            {/* <div className="flex gap-2">
                <input type="radio" />
                <label className="text-lg">За всички панели ({panelCount})</label>
            </div> */}
