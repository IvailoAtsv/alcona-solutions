        ...
        <FormWrapper title={title}>
            ...
            <div className="w-full flex flex-col sm:flex-row justify-evenly items-center">
                <div className="flex w-full flex-col justify-center items-center">
                    ...
                    <img src={plastic} className='sm:w-[20%] w-[80%] h-[80%] sm:h-[20%] rounded-md' />
                    <label className="text-xl font-semibold">Брой:  </label>
                    <input type="number" name="plastic" onChange={(e) => validate(e)} className="w-[220px] h-[30px] bg-gray-200 text-xl text-center rounded-md px-2 py-1" />
                </div>
                <div className="flex w-full flex-col justify-center items-center">
                    <p className=" text-xl font-semibold text-center pb-2">Соларна</p>
                    <img src={solar} className='sm:w-[50%] w-[80%] h-[80%] sm:h-[50%]  rounded-md' />
                    <label className="text-xl font-semibold">Брой:  </label>
                    <input name="solar" type="number" onChange={(e) => validate(e)} className="w-[220px] h-[30px] bg-gray-200 text-xl text-center rounded-md px-2 py-1" />
                </div>
                <div className="flex w-full flex-col justify-center items-center">
                    <p className=" text-xl font-semibold text-center pb-2">LED 12v</p>
                    <img name="Caps" src={led} className='sm:w-[50%] w-[80%] h-[80%] sm:h-[50%]  rounded-md' />
                    <label className="text-xl font-semibold">Брой: </label>
                    <input type="number" name="led" onChange={(e) => validate(e)} className="w-[220px] h-[30px] bg-gray-200 text-xl text-center rounded-md px-2 py-1" />
                </div>
            </div>
