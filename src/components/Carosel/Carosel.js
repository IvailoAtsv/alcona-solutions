...
export const Carosel = ({ description }) => {
    ...
    return (
        <div className="flex w-[90%] flex-col-reverse md:flex-row justify-between gap-2 items-center max-w-[1400px]">
            <section
                aria-label="Image Slider"
                className="w-full h-[60vh]  sm:max-w-[60vh] relative"
            >
            ...
            <div className="md:w-[30%] w-[80%] flex flex-col justify-center items-center">
