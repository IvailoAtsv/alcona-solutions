    ...
    return (
        <>
            ...
            <div className="sm:w-full w-[95%] max-w-[1600px] my-12 flex-col flex justify-between items-center">
                ...
                <a className="rounded-lg py-2 px-4 border-4 self-center font-bold duration-500 mt-6 border-black hover:bg-black hover:text-white" href="https://www.facebook.com/people/Luxury-Fences-WPC-%D0%9E%D0%B3%D1%80%D0%B0%D0%B4%D0%B8/61553632407058/">Разгледайте още на нашата facebook страница</a>
