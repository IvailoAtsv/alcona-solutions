export const Contact = () => {
  ...
  return (
    <div className="w-full overflow-hidden h-[80vh] flex-col flex justify-center items-center">
      ...
      <form className=" w-[80%] border-b-4 border-r-4 border-l-4 border-background bg-white rounded-b-md backdrop-blur-md justify-center items-center flex flex-col h-[60%]">
