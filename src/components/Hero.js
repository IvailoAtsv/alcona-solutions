...
const Hero = () => {
  return (
    <div className="w-full text-center flex bg-no-repeat bg-right bg-fixed bg-cover justify-center items-center bg-hero3 h-[85vh]">
      <div className="w-full  max-w-[1400px] sm:w-[90%] h-full sm:h-11/12 sm:flex-row flex flex-col-reverse md:justify-between justify-evenly items-center gap-4">
        <div className="flex backdrop-blur-md min-w-[250px] text-start sm:w-[30%] w-[90%] sm:max-w-[450px] 2-3 h-[50%] rounded-xl items-start p-2 bg-cardBg flex-col justify-evenly">
